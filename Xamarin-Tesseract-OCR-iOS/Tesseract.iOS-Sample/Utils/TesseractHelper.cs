...
namespace Tesseract.iOSSample
{
	...
	{
		public static Tesseract.iOS.Tesseract CreateTesseract(string trainingDataPath = "tessdata", string languages = "eng") 
		{
			...
			return new Tesseract.iOS.Tesseract (trainingDataPath, languages);
		}
	}
}
